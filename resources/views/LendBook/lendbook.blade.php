...
<div class="container">
    ...
    <form class="form-horizontal" method="POST" action="/lendbook">
        ...
        <fieldset>
            ...
            <div class="form-group">
              <label for="inputEmail" class="col-lg-3 control-label">Borrower Registration Number:</label>
              <div class="col-lg-5">
        ...
        <div class="form-group">
          <label for="inputb" class="col-lg-3 control-label">Book Access No: </label>
          <div class="col-lg-5">
    ...
    <div class="form-group">
      <label for="inputl" class="col-lg-3 control-label">Number of days: </label>
      <div class="col-lg-5">
...
<h2> Borrower ID: <?php echo $request->regno ?> </h2>
<h2> Book ID: <?php echo $request->book_id ?> </h2>
