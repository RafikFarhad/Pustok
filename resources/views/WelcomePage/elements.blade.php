...
<html>
	...
	<body class="subpage">
		...
		<!-- Header -->
			<header id="header">
				<div class="inner">
					<a href="WelcomePage/index" class="logo"><strong>Projection</strong> by TEMPLATED</a>
					<nav id="nav">
						<a href="WelcomePage/index">Home</a>
						<a href="WelcomePage/generic">Generic</a>
						<a href="WelcomePage/elements">Elements</a>
					</nav>
